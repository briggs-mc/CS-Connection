...
//{
    ...
    class FillDatabase
    {
        ...
        public void getRoster(string excelFileName)
        {
            ...
            ExcelReader.ExcelReader.readWorksheet(workbook, out course_, out studentID_, 
        ...
        //databse connection must have already been done
        ...
        public string[] getClassesStudentTaking(string emailStudent)
        {
            //call database connection function
            OleDbConnection connection = DatabaseConnector.CommonFunctions.connectToDB();
            ...
            //run the query and get back the number of rows that match the query
            string[] listClassesStudentTaking = DatabaseConnector.CommonFunctions.readData(connection, returnClassesStudentTakin);
