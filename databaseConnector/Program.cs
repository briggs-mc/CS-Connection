...
namespace ExcelReader
{
    class Program
    {
        static void Main()
        {
            ...
            string[] Email;
            //object[,] valueArray = 
            ExcelReader.Program.readWorksheet(workbook, out Course, out StudentID, 
            ...
            string command = "INSERT INTO userInfo VALUES (" + " 'jfkldsf'" + ", '" + StudentID[2] + "', '" + LastName[2] + "', '" + FirstName[2] + "', '" + Course[2] + "','123', '234', '466', '435', '344');";
